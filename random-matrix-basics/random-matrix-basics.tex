...
\begin{align*}
	...
	& = \pi f(\tau),
\end{align*} 
with the last equality following since the Poisson kernels $P_{\varepsilon}(x) = \frac{1}{\pi} \frac{\varepsilon}{x^2 + \varepsilon^2}$ form a family of approximations to the identity. On the other hand, 
$$
...
$$
Finally, manipulating the self-consistency equation for $e^{\ast}$ gives that $x^{\ast} = x(e^{\ast}) = -z v(z)$, since
\begin{align*}
